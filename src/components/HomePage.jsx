          ...
          <Col className="text-center">
            <div>
              ...
              <p className="px-5 mb-5">
                ...
                vegan recipes. Whether you are a seasoned vegan or just starting your plant-based journey, our
                application is designed to help you find, create, and enjoy meals that suit your ingredients and
                nutritional needs. With an intuitive user interface and smart features, The Plant Based Hub aims to{" "}
                <strong>minimize food waste</strong> and make <strong>healthy eating more accessible</strong>.
              </p>
            </div>
            <div>
              ...
              <div className="mb-5">
                ...
                <p className="px-5">
                  ...
                  <br />
                  Input the ingredients you have at home and discover elaborate vegan recipes that utilize them best.
                </p>
                <p className="px-5">
                  <strong>
                  ...
                  <br />
                  Select recipes based on key nutritional groups like proteins, carbohydrates, fibers, sugars, minerals
                  and vitamins for well-balanced meals.
                </p>
                <p className="px-5">
                  <strong>
            ...
            <div>
              ...
              <div>
                ...
                <div className="mb-5">
                  <p className="px-5">
                    Discover a wide array of <strong>categorized vegan recipes</strong> for easy browsing. From hearty
                    breakfasts to the most delightful desserts, The Plant Based Hub offers something for every meal and
                    occasion.
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="mb-5">
                  <p className="px-5">
                    Create <strong>nutritionally balanced meals</strong> by filtering recipes according to your dietary
                    preferences. Whether you need more protein, fiber, or specific vitamins, our application helps you
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div className="mb-5">
                      <p className="px-5">
                        Engage with a community of like-minded individuals by sharing your favourite recipes and rating
                        others. Enjoy a <strong>social cooking experience</strong> that encourages the exchange of ideas
                        and inspiration.
                      </p>
                    </div>
                  </div>
            ...
            <div>
              <h4 className="homeSubtitle mx-5 mb-4">
                Let The Plant Based Hub be your guide to discovering the endless possibilities of vegan cuisine. Embark
                on a fresh journey through plant based kitchen and transform the way you cook and eat!
              </h4>
            </div>
            <hr className="greenHr" />
